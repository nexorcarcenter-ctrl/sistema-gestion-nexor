  ...
  return (
    <tr className="hover:bg-slate-50 transition-colors group">
      ...
      <td className="px-4 py-3 whitespace-nowrap text-right">
        <span className="text-sm font-semibold text-orange-600">{fmt(product.unitPrice)}</span>
      </td>
      ...
      <td className="px-4 py-3 whitespace-nowrap text-right">
        <div className="flex flex-col items-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-100 hover:bg-orange-100 text-slate-600 hover:text-orange-700 text-xs font-medium transition-colors"
          >
